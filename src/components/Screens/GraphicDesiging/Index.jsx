...
import Group35096 from './Group35096.png'
import Group35104 from './Group35104.png'
...
import rank_89 from './rank_89015321.png'
const Index = () => {
  return (
   <Fragment>
  <div className="single-services-page">
      <div className="div">
        <div className="overlap">
          ...
          <div className="group">
            <div className="overlap-group">
              ...
              <img className="group-2" alt="Group" src={Group35096} />
        ...
        <div className="overlap-2">
          <img className="group-9" alt="Group" src="group-35061.png" />
        ...
        <div className="overlap-7">
          ...
          <div className="frame-9">
            ...
            <div className="send-your-enguiry-wrapper">
        ...
        <div className="overlap-8">
          ...
          <img className="vector-5" alt="Vector" src="vector.svg" />
          <img className="image" alt="Image" src={image41} />
        </div>
        <div className="overlap-9">
          <div className="overlap-10">
            <div className="rectangle-8" />
            <img className="group-15" alt="Group" src="group-35061-2.png" />
                  ...
                  <div className="group-wrapper">
                    <div className="group-18">
                      <div className="frame-13">
                        ...
                        <img className="arrow" alt="Arrow" src="arrow-4.svg" />
                      </div>
                  ...
                  <div className="group-20">
                    <div className="group-21">
                      <div className="frame-14">
                        <div className="text-wrapper-13">Read More</div>
                        <img className="arrow" alt="Arrow" src="arrow-4-2.svg" />
                      </div>
                ...
                <div className="overlap-group-3">
                  <div className="group-20">
                    <div className="group-21">
                      <div className="frame-14">
                        <div className="text-wrapper-13">Read More</div>
                        <img className="arrow" alt="Arrow" src="arrow-4-3.svg" />
                      </div>
              ...
              <div className="overlap-13">
                <div className="group-wrapper">
                  <div className="group-18">
                    <div className="frame-13">
                      <div className="text-wrapper-13">Read More</div>
                      <img className="arrow" alt="Arrow" src="arrow-4-4.svg" />
                    </div>
                ...
                <div className="group-22">
                  <div className="group-23">
                    <div className="frame-15">
                      <div className="text-wrapper-13">Read More</div>
                      <img className="arrow" alt="Arrow" src="arrow-4-5.svg" />
                    </div>
              ...
              <div className="overlap-15">
                <div className="group-20">
                  <div className="group-21">
                    <div className="frame-14">
                      <div className="text-wrapper-13">Read More</div>
                      <img className="arrow" alt="Arrow" src="arrow-4-6.svg" />
                    </div>
                    ...
                    <div className="div-2">
                      <img className="image-2" alt="Image" src="image-46.png" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="OBJECTS">
              <div className="group-25">
                <div className="overlap-group-4">
                  <img className="vector-6" alt="Vector" src="image.svg" />
        ...
        <div className="group-41">
          <div className="overlap-19">
            ...
            <img className="image-6" alt="Image" src="image-41-2.png" />
