        ...
        <div className="overlap">
            ...
            <div className="overlap-group">
              <div className="overlap-group-2">
                <img
                  ...
                  src="give-your-business-a-digital-edge.svg"
                />
          ...
          <div className="overlap-group-wrapper">
            <div className="overlap-2">
              ...
              <img className="group-4" alt="Group" src="group-44.png" />
              <img className="arrow-2" alt="Arrow" src="arrow-5.svg" />
            </div>
          </div>
          <img className="image" alt="Image" src="image-9.png" />
          <img className="image-2" alt="Image" src="image-47-2.png" />
              ...
              <div className="frame-3">
                <div className="group-7">
                  <div className="overlap-group-4">
                    <img className="image-3" alt="Image" src="image-25.png" />
                ...
                <div className="group-7">
                  <div className="overlap-4">
                    ...
                    <img className="image-4" alt="Image" src="image-29.png" />
                ...
                <div className="group-8">
                  <div className="overlap-group-4">
                    ...
                    <img className="image-5" alt="Image" src="image-26.png" />
              ...
              <div className="frame-3">
                <div className="group-7">
                  <div className="overlap-group-4">
                    ...
                    <img className="image-3" alt="Image" src="image-28.png" />
                  </div>
                </div>
                <div className="group-8">
                  <div className="overlap-5">
                    ...
                    <img className="image-6" alt="Image" src="image-30.png" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <img
            ...
            src="portrait-attractive-adult-man-smiling-pointing-fingers-right-logo-banner-showing-advertisement-against-blue-background-1.png"
          />
          ...
          <div className="overlap-8">
            ...
            <div className="group-10">
              ...
              <div className="group-13">
                <div className="frame-8">
                  <div className="text-wrapper-17">Read More</div>
                  <img className="arrow-3" alt="Arrow" src="arrow-4.svg" />
                </div>
              ...
              <div className="group-14">
                <div className="frame-9">
                  <div className="text-wrapper-17">Read More</div>
                  <img className="arrow-3" alt="Arrow" src="image.svg" />
                </div>
            ...
            <div className="group-15">
              ...
              <div className="frame-11">
                <div className="text-wrapper-17">Read More</div>
                <img className="arrow-3" alt="Arrow" src="arrow-3-2.svg" />
              </div>
            </div>
            ...
            <div className="group-16">
              <div className="overlap-9">
                ...
                <img className="image-8" alt="Image" src="image-20.png" />
              </div>
            </div>
            <img className="group-17" alt="Group" src="group-35081.png" />
            <div className="rectangle-11" />
            <div className="rectangle-12" />
            <img className="group-18" alt="Group" src="group-35061.png" />
            ...
            <div className="group-19">
              <div className="group-20">
                ...
                <div className="frame-12">
                  <div className="text-wrapper-17">Read More</div>
                  <img className="arrow-3" alt="Arrow" src="arrow-3-3.svg" />
                </div>
              </div>
              <div className="overlap-10">
                ...
                <div className="frame-13">
                  <div className="text-wrapper-17">Read More</div>
                  <img className="arrow-3" alt="Arrow" src="arrow-3-4.svg" />
                </div>
                <div className="group-21">
                  <div className="overlap-group-6">
                    ...
                    <div className="frame-14">
                      <div className="text-wrapper-17">Read More</div>
                      <img className="arrow-3" alt="Arrow" src="arrow-3-5.svg" />
                    </div>
                  </div>
                </div>
                <div className="group-22">
                  <div className="overlap-group-6">
                    ...
                    <div className="frame-14">
                      <div className="text-wrapper-17">Read More</div>
                      <img className="arrow-3" alt="Arrow" src="arrow-3-6.svg" />
                    </div>
                  </div>
                </div>
                ...
                <div className="group-23">
                  <div className="overlap-group-6">
                    ...
                    <div className="frame-14">
                      <div className="text-wrapper-17">Read More</div>
                      <img className="arrow-3" alt="Arrow" src="arrow-3-7.svg" />
                    </div>
                  </div>
                </div>
                <img className="pencil-ruler" alt="Pencil ruler" src="pencil-ruler-10037456-1.png" />
                <img className="image-9" alt="Image" src="image-22.png" />
                <img className="image-10" alt="Image" src="image-23.png" />
                <img className="image-11" alt="Image" src="image-24.png" />
              </div>
            </div>
            <div className="frame-15">
              <div className="text-wrapper-17">See More</div>
              <img className="arrow-3" alt="Arrow" src="arrow-3-8.svg" />
            </div>
            ...
            <img className="rectangle-15" alt="Rectangle" src="rectangle-49.svg" />
            <img className="rectangle-16" alt="Rectangle" src="rectangle-55.svg" />
            <img className="rectangle-17" alt="Rectangle" src="rectangle-50.svg" />
            <img className="rectangle-18" alt="Rectangle" src="rectangle-56.svg" />
            <img className="rectangle-19" alt="Rectangle" src="rectangle-51.svg" />
            <img className="rectangle-20" alt="Rectangle" src="rectangle-57.svg" />
            <img className="pencil-ruler-2" alt="Pencil ruler" src="pencil-ruler-10037456-1-2.png" />
            <img className="image-12" alt="Image" src="image-22-2.png" />
          </div>
          <div className="overlap-11">
            <div className="group-24">
              ...
              <div className="overlap-15">
                ...
                <img className="image-14" alt="Image" src="image-3.png" />
                ...
                <div className="frame-24">
                  <div className="text-wrapper-42">Home</div>
                  <div className="text-wrapper-42">Services</div>
                  <div className="text-wrapper-42">About Us</div>
            ...
            <img
              ...
              src="advertising-concept-happy-young-european-woman-with-fair-hair-blue-clothes-standing-against-gray-concrete-wall-background-with-copy-space-your-information-promotional-content-1.png"
            />
          </div>
          <img className="ellipse-20" alt="Ellipse" src="ellipse-46.svg" />
        </div>
